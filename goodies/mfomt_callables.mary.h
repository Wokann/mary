/* MFoMT ordered callable IDs. Select MARY_MFOMT_US or MARY_MFOMT_JP.
 *
 * MFoMT semantics are verified from its ROM handlers and scripts; US/JP
 * localization differences are selected inside this MFoMT-only table.
 *
 * MFoMT 有序 callable ID。请选择 MARY_MFOMT_US 或 MARY_MFOMT_JP。
 *
...
mary_callable_table
{
    ...
    /* 0x01E */ ResetTalkUi,
    /* 0x01F */ TalkOpen,
    /* 0x020 */ TalkOpenNoPortrait,
    /* 0x021 */ TalkClose,
    /* 0x022 */ TalkMessage,
    /* 0x023 */ TalkMessageSlow,
    /* 0x024 */ TalkAppendMessage,
    /* 0x025 */ TalkPromptChoice2,
    /* 0x026 */ TalkPromptChoice3,
    /* 0x027 */ TalkPromptChoice4,
    /* 0x028 */ TalkChoice2,
    /* 0x029 */ TalkChoice3,
    /* 0x02A */ TalkChoice4,
    /* 0x02B */ TalkChoice5,
    /* 0x02C */ TalkChoice6,
    /* 0x02D */ SetTalkNameplateCharacter,
    /* 0x02E */ SetTalkNameplateText,
    /* 0x02F */ ClearTalkNameplate,
    /* 0x030 */ SetTalkPortrait,
    /* 0x031 */ ClearTalkPortrait,
    /* 0x032 */ ShowTalkHeartIndicator,
    /* 0x033 */ HideTalkHeartIndicator,
    /* 0x034 */ FadeOutScreen,
    /* 0x035 */ FadeInScreen,
    /* 0x036 */ FadeInScreenWithoutSceneHook,
    /* 0x037 */ WaitFrames,
    /* 0x038 */ CallScript,
    /* 0x039 */ SetTextVariableNumber,
    /* 0x03A */ SetTextVariableNumberFieldWidth,
    /* 0x03B */ SetTextVariableString,
    /* 0x03C */ RandomU15,
    /* 0x03D */ RandomIntInclusive,
    /* 0x03E */ VarGet,
    /* 0x03F */ VarSet,
    /* 0x040 */ IsPlayerHoldingNothing,
    /* 0x041 */ GetPlayerHeldItemKind,
    /* 0x042 */ IsPlayerHeldItemWrapped,
    /* 0x043 */ GetPlayerHeldFoodId,
    /* 0x044 */ GetPlayerHeldArticleId,
    /* 0x045 */ GetPlayerHeldChickenId,
    /* 0x046 */ UsePlayerHeldItem,
    /* 0x047 */ ClearPlayerHeldItem,
    /* 0x048 */ SetPlayerHeldFood,
    /* 0x049 */ SetPlayerHeldArticle,
    /* 0x04A */ SetPlayerHeldWrappedFood,
    /* 0x04B */ SetPlayerHeldWrappedArticle,
    /* 0x04C */ CanDiscardPlayerHeldArticle,
    /* 0x04D */ TryShipPlayerHeldItem,
    /* 0x04E */ ThrowPlayerHeldItem,
    /* 0x04F */ GetPlayerHeldToolId,
    /* 0x050 */ GetPlayerHeldToolStackCount,
    /* 0x051 */ SetPlayerHeldTool,
    /* 0x052 */ ClearPlayerHeldTool,
    /* 0x053 */ FindFoodInRucksack,
    /* 0x054 */ FindArticleInRucksack,
    /* 0x055 */ ClearRucksackItemSlot,
    /* 0x056 */ GetFirstFreeRucksackToolSlot,
    /* 0x057 */ GetFirstFreeRucksackItemSlot,
    /* 0x058 */ AddArticleToRucksack,
    /* 0x059 */ AddFoodToRucksack,
    /* 0x05A */ AddToolToRucksack,
    /* 0x05B */ ShowPlayerHoldingTool,
    /* 0x05C */ ChangePlayerStaminaAndFatigue,
    /* 0x05D */ IsPlayerHoldingTool,
    /* 0x05E */ PlayerOwnsTool,
    /* 0x05F */ PlayerOwnsFood,
    /* 0x060 */ PlayerOwnsArticle,
    /* 0x061 */ RemoveAllOwnedArticles,
    /* 0x062 */ ObtainPowerBerry,
    /* 0x063 */ ObtainMysticBerry,
    /* 0x064 */ IsPlayerRidingHorse,
    /* 0x065 */ EnterHotSpringBathingState,
    /* 0x066 */ ExitHotSpringBathingState,
    /* 0x067 */ PreservePlayerLocationForNextDay,
    /* 0x068 */ ClearPreservedPlayerLocation,
    /* 0x069 */ GetPreservedPlayerMapId,
    /* 0x06A */ EatRandomMeal,
    /* 0x06B */ PreparePlayerForScriptedAnimation,
    /* 0x06C */ RestorePlayerAfterScriptedAnimation,
    /* 0x06D */ GetPresentedItemKind,
    /* 0x06E */ GetPresentedItemId,
    /* 0x06F */ IsPresentedItemGiftWrapped,
    /* 0x070 */ CanReceiveTool,
    /* 0x071 */ CanReceiveFood,
    /* 0x072 */ CanReceiveArticle,
    /* 0x073 */ GivePlayerBasket,
    /* 0x074 */ PlayerHasBasket,
    /* 0x075 */ UpgradeRucksack,
    /* 0x076 */ GetRucksackUpgradeLevel,
    /* 0x077 */ SetPlayerActorUpdateSuspended,
    /* 0x078 */ GetPlayerOutfitColor,
    /* 0x079 */ SetPlayerOutfitColor,
    /* 0x07A */ HasLocalLinkMilestone,
    /* 0x07B */ HasReceivedLinkMilestone,
    /* 0x07C */ SetLocalLinkMilestone,
    /* 0x07D */ ClearLocalLinkMilestone,
    /* 0x07E */ IsCharacterBirthdayToday,
    /* 0x07F */ GetNpcFriendship,
    /* 0x080 */ AddNpcFriendship,
    /* 0x081 */ SetNpcFriendship,
    /* 0x082 */ GetDaysSinceLastSpokenToNpc,
    /* 0x083 */ MarkNpcSpokenTo,
    /* 0x084 */ WasNpcSpokenToToday,
    /* 0x085 */ WasNpcSpokenToJustNow,
    /* 0x086 */ HasMetNpc,
    /* 0x087 */ MarkNpcGifted,
    /* 0x088 */ WasNpcGiftedToday,
    /* 0x089 */ GetCharacterLove,
    /* 0x08A */ AddCharacterLove,
    /* 0x08B */ SetCharacterLove,
    /* 0x08C */ SetEntityEventScript,
    /* 0x08D */ ClearEntityEventScript,
    /* 0x08E */ OpenSupermarketShop,
    /* 0x08F */ PurchaseSupermarketItem,
    /* 0x090 */ OpenWonShop,
    /* 0x091 */ OpenCarpenterShop,
    /* 0x092 */ OpenBlacksmithShop,
    /* 0x093 */ OpenClinicShop,
    /* 0x094 */ OpenBeachCafeShop,
    /* 0x095 */ OpenYodelRanchShop,
    /* 0x096 */ OpenWineryShop,
    /* 0x097 */ OpenInnShop,
    /* 0x098 */ OpenPoultryFarmShop,
    /* 0x099 */ OpenSpecialMerchantShop,
    /* 0x09A */ OpenGiftWrappingMenu,
    /* 0x09B */ ShowReferencePage,
    /* 0x09C */ OpenBookList,
    /* 0x09D */ OpenLetterList,
    /* 0x09E */ OpenCalendar,
    /* 0x09F */ OpenShelf,
    /* 0x0A0 */ OpenToolChest,
    /* 0x0A1 */ OpenRefrigerator,
    /* 0x0A2 */ OpenClock,
    /* 0x0A3 */ OpenCookingMenu,
    /* 0x0A4 */ OpenRecipeList,
    /* 0x0A5 */ RunGameCubeLink,
    /* 0x0A6 */ OpenNameEntry,
    /* 0x0A7 */ StartFarmInheritanceFlashback,
    /* 0x0A8 */ OpenNameEntryKeyboard,
    /* 0x0A9 */ OpenRucksackMenu,
    /* 0x0AA */ SelectFestivalAnimal,
    /* 0x0AB */ RunStaffCredits,
    /* 0x0AC */ OpenFarmingTutorial,
    /* 0x0AD */ PrepareClockMenuTransition,
    /* 0x0AE */ RestoreAfterClockMenu,
    /* 0x0AF */ PrepareCookingMenuTransition,
    /* 0x0B0 */ RestoreAfterCookingMenu,
    /* 0x0B1 */ PrepareRecipeMenuTransition,
    /* 0x0B2 */ RestoreAfterRecipeMenu,
    /* 0x0B3 */ RecordPlayerHasAlbum,
    /* 0x0B4 */ SwapRecordPlayerAlbum,
    /* 0x0B5 */ RemoveRecordPlayerAlbum,
    /* 0x0B6 */ LightFireplaceAtLocation,
    /* 0x0B7 */ IsFireplaceLitAtLocation,
    /* 0x0B8 */ SetVaseArticleId,
    /* 0x0B9 */ GetVaseArticleId,
    /* 0x0BA */ IsChickenFeedTroughFilled,
    /* 0x0BB */ FillChickenFeedTrough,
    /* 0x0BC */ BeginEggIncubation,
    /* 0x0BD */ IsIncubatorOccupied,
    /* 0x0BE */ GetIncubatorCapacity,
    /* 0x0BF */ IsEggReadyToHatch,
    /* 0x0C0 */ AttemptEggHatch,
    /* 0x0C1 */ IsBarnFeedTroughFilled,
    /* 0x0C2 */ FillBarnFeedTrough,
    /* 0x0C3 */ StartShipmentBoxDepositAnimation,
    /* 0x0C4 */ GetPregnancyStallCapacity,
    /* 0x0C5 */ IsBarnAnimalReadyToGiveBirth,
    /* 0x0C6 */ AttemptBarnAnimalBirth,
    /* 0x0C7 */ BuildMountainCottage,
    /* 0x0C8 */ BuildSeasideCottage,
    /* 0x0C9 */ HasGoldenLumberOnFarm,
    /* 0x0CA */ OpenDoor,
    /* 0x0CB */ CloseDoor,
    /* 0x0CC */ RedrawRucksackShelfAfterPurchase,
    /* 0x0CD */ RedrawBlueFeatherShelfAfterPurchase,
    /* 0x0CE */ GetHarvestSpriteCurrentTask,
    /* 0x0CF */ GetHarvestSpriteWorkDaysLeft,
    /* 0x0D0 */ GetHarvestSpriteTaskExperience,
    /* 0x0D1 */ HasHarvestSpritePlayedMinigameToday,
    /* 0x0D2 */ HasHarvestSpriteMinigameExperience,
    /* 0x0D3 */ StartHarvestSpriteTask,
    /* 0x0D4 */ ScheduleHarvestSpriteTaskToEndAfterToday,
    /* 0x0D5 */ IsHarvestSpriteDailyWorkComplete,
    /* 0x0D6 */ RunHarvestSpriteAnimalCareMinigame,
    /* 0x0D7 */ RunHarvestSpriteHarvestingMinigame,
    /* 0x0D8 */ RunHarvestSpriteWateringMinigame,
    /* 0x0D9 */ RunChickenFestivalContest,
    /* 0x0DA */ RunHorseRace,
    /* 0x0DB */ PrepareHorseRaceEntries,
    /* 0x0DC */ OpenHorseRaceMedalExchange,
    /* 0x0DD */ RunFrisbeeGame,
    /* 0x0DE */ RunFrisbeeTournamentRound,
    /* 0x0DF */ PrepareAnimalFestivalOpponents,
    /* 0x0E0 */ GetTVShoppingSelection,
    /* 0x0E1 */ GetPendingTVShoppingItem,
    /* 0x0E2 */ IsTVShoppingDeliveryReady,
    /* 0x0E3 */ SetTVShoppingSelection,
    /* 0x0E4 */ ConfirmTVShoppingOrder,
    /* 0x0E5 */ CompleteTVShoppingDelivery,
    /* 0x0E6 */ IsVacationVillaBuilt,
    /* 0x0E7 */ AreAllRequiredVillagersAtMaxFriendship,
    /* 0x0E8 */ HasShippedOneOfEachCrop,
    /* 0x0E9 */ AreAllFarmAnimalsAtMaxAffection,
    /* 0x0EA */ HasShippedOneOfEachMineral,
    /* 0x0EB */ HasCaughtEveryFishSpecies,
    /* 0x0EC */ GetTotalFishCaught,
    /* 0x0ED */ HasObtainedMythicTool,
    /* 0x0EE */ HasShippedOneOfEachProduct,
    /* 0x0EF */ GetMoney,
    /* 0x0F0 */ AddMoney,
    /* 0x0F1 */ SubtractMoney,
    /* 0x0F2 */ EnableScriptedNpcControl,
    /* 0x0F3 */ DisableScriptedNpcControl,
    /* 0x0F4 */ GetBlacksmithOrderId,
    /* 0x0F5 */ IsBlacksmithOrderReady,
    /* 0x0F6 */ CollectBlacksmithOrder,
    /* 0x0F7 */ SetGameTime,
    /* 0x0F8 */ IsLetterWaiting,
    /* 0x0F9 */ HasReceivedLetter,
    /* 0x0FA */ DeliverLetter,
    /* 0x0FB */ MarkLetterRead,
    /* 0x0FC */ GetWaitingLetterCount,
    /* 0x0FD */ GetSavedLetterCount,
    /* 0x0FE */ ShowTelevisionMessage,
    /* 0x0FF */ SetTelevisionProgram,
    /* 0x100 */ EndTelevisionProgram,
    /* 0x101 */ RefreshAllNpcSchedules,
    /* 0x102 */ DoesAnimalExist,
    /* 0x103 */ CreateFarmHorse,
    /* 0x104 */ RemoveFarmHorse,
    /* 0x105 */ GetAnimalName,
    /* 0x106 */ GetInteractingAnimalIndex,
    /* 0x107 */ HasAnimalBeenTalkedTo,
    /* 0x108 */ SetAnimalTalkedTo,
    /* 0x109 */ AddAnimalAffection,
    /* 0x10A */ IsAnimalUnhappy,
    /* 0x10B */ IsAnimalSick,
    /* 0x10C */ IsAnimalPregnant,
    /* 0x10D */ GetAnimalHealthyPregnancyDays,
    /* 0x10E */ GetAnimalAge,
    /* 0x10F */ GetAnimalAffection,
    /* 0x110 */ GetAnimalGrowthStage,
    /* 0x111 */ IsSheepSheared,
    /* 0x112 */ CountAnimalsByLifeState,
    /* 0x113 */ ShowLivestockNeglectDeathSummary,
    /* 0x114 */ RemoveLivestockDeadFromNeglect,
    /* 0x115 */ ShowNaturalLivestockDeathSummary,
    /* 0x116 */ RemoveNaturallyDeadLivestock,
    /* 0x117 */ IsCowAtBarnSlot,
    /* 0x118 */ GetCowCount,
    /* 0x119 */ GetSheepCount,
    /* 0x11A */ GetChickenCount,
    /* 0x11B */ SetContestAnimal,
    /* 0x11C */ ClearContestAnimal,
    /* 0x11D */ GetContestAnimalIndex,
    /* 0x11E */ SetTextVariableToCaughtFishName,
    /* 0x11F */ GetCaughtFishSize,
    /* 0x120 */ IsCaughtFishMaximumSize,
    /* 0x121 */ IsCaughtFishKing,
    /* 0x122 */ SelectMoonViewingPartner,
    /* 0x123 */ SelectMoonViewingPartnerAlias,
    /* 0x124 */ GetCookingFestivalDishRating,
    /* 0x125 */ SelectThomasStockingGift,
    /* 0x126 */ GetRandomSpouseGiftArticleId,
    /* 0x127 */ UnlockNextVanAlbum,
    /* 0x128 */ AreAllVanAlbumsAvailable,
    /* 0x129 */ SetPlayerNicknameForSpouse,
    /* 0x12A */ PlacePlayerAtFarmhouseBed,
    /* 0x12B */ FlashScreenColor,
    /* 0x12C */ RebuildMapEntitiesForNewDay,
    /* 0x12D */ CureAllSickLivestock,
    /* 0x12E */ AddAffectionToAllFarmAnimals,
    /* 0x12F */ EnableShootingStarShippingBonus,
    /* 0x130 */ GetAmountShipped,
    /* 0x131 */ CreatePlayerChildEntity,
    /* 0x132 */ RelocateEntityToMap,
    /* 0x133 */ CreateNewYearSunriseEffect,
    /* 0x134 */ PlayNewYearSunriseEffect,
    /* 0x135 */ DestroyNewYearSunriseEffect,
    /* 0x136 */ PlayStarSparkleEffect,
    /* 0x137 */ GetKnownRecipeCount,
    /* 0x138 */ GenerateMineFloorLayout,
    /* 0x139 */ DescendMineFloor,
    /* 0x13A */ IsToolCursed,
    /* 0x13B */ AdvanceCursedToolLiftProgress,
    /* 0x13C */ AttemptChurchCursedToolRemoval,
    /* 0x13D */ CreateEventIcon,
    /* 0x13E */ RemoveEventIcon,
    /* 0x13F */ GetFoodIconId,
    /* 0x140 */ GetArticleIconId,
    /* 0x141 */ GetToolIconId,
    /* 0x142 */ NoOpTutorialFieldTile,
    /* 0x143 */ NoOpTutorialFieldObject,
    /* 0x144 */ NoOpTutorialEggDefinition,
    /* 0x145 */ NoOpTutorialEggSelection,
    /* 0x146 */ BeginHoldingActorGraphic,
    /* 0x147 */ NoOpAnimalEventEntityInitialization,
    /* 0x148 */ SetTextVariableToProductName,
    /* 0x149 */ GetEventContextValue,
    /* 0x14A */ CycleBackwardToNonCursedTool,
    /* 0x14B */ IsMayonnaiseMakerInstalled,
    /* 0x14C */ IsCheeseMakerInstalled,
    /* 0x14D */ IsYarnMakerInstalled,
 ...
 *
 * Mary*Id and Mary*Kind accept symbols from mfomt_constants.mary.h or original
 ...
 *
 * Mary*Id、Mary*Kind 可使用 mfomt_constants.mary.h 的符号或原始整数，
 * 两者编译字节完全相同。
 *
 ...
 * Parameter: script_id is a SCRIPT_* symbol from mfomt_scripts.mary.h or the
 ...
 * 参数：script_id 为 mfomt_scripts.mary.h 中的 SCRIPT_* 符号或精确数字脚本 ID；
 * 两种形式编译为同一个整数。
...
/*
 * Returns the female protagonist's current outfit color from the low three
 * bits of the saved outfit-state byte.
 * Parameters: none.
 * Return value: one of the six MaryOutfitColor values (0 through 5).
 *
 * 从服装状态存档字节的低三位返回女主角当前的服装颜色。
 * 参数：无。
 * 返回值：六个 MaryOutfitColor 值之一（0 到 5）。
 */
 ...
 * Values outside 0 through 5 are ignored. A valid change preserves the upper
 * state bits and sets bit 3, which marks the outfit state for refresh; writing
 * the already selected color has no effect.
 *
 * 更改女主角的服装颜色。
 * 参数：color 为 OUTFIT_COLOR_*。
 * 0 到 5 以外的值会被忽略。有效变更会保留高位状态并设置 bit 3，标记服装状态
 * 需要刷新；再次写入当前颜色不会产生效果。
 */
 ...
 * mfomt_scripts.mary.h or the exact target-specific script-table ID.
 ...
 *
 * 为当前场景中的实体绑定事件脚本。
 * 参数：entity_id 选择场景实体；script_id 为 mfomt_scripts.mary.h 中的符号或
 ...
 * Parameters: none.
 * Return value: FESTIVAL_MOON_VIEWING_PARTNER_*, identical to SelectMoonViewingPartner.
 *
 ...
 * 参数：无。
 * 返回值：FESTIVAL_MOON_VIEWING_PARTNER_*，与 SelectMoonViewingPartner 完全一致。
 */
MaryFestivalMoonViewingPartner SelectMoonViewingPartnerAlias(void);
/*
...
/*
 * Tests whether the Mayonnaise Maker has been installed in the expanded Coop.
 * Parameters: none. Return value: the persistent installation flag. The native
 * blacksmith-order completion path sets this exact flag when order 35
 * (BLACKSMITH_ORDER_MAYONNAISE_MAKER) finishes. This is not an incubator-slot
 * occupancy query: actual incubator occupancy is stored in each indexed record.
 *
 * 判断扩建后的鸡舍是否已经安装蛋黄酱加工机。
 * 参数：无。返回值：持久安装标记。原生锻冶屋订单完成路径会在编号 35
 *（BLACKSMITH_ORDER_MAYONNAISE_MAKER）完成时设置这个准确状态位。它并非
 * 孵化箱槽位占用查询；真正的占用状态保存在每个带索引的记录中。
 */
MaryBool IsMayonnaiseMakerInstalled(void);

/*
 * Tests whether the Cheese Maker has been installed in the expanded Barn.
 * Parameters: none. Return value: the persistent installation flag. The native
 * blacksmith-order completion path sets this exact flag when order 36
 * (BLACKSMITH_ORDER_CHEESE_MAKER) finishes. It does not inspect either indexed
 * pregnancy-stall link.
 *
 * 判断扩建后的畜棚是否已经安装奶酪加工机。
 * 参数：无。返回值：持久安装标记。原生锻冶屋订单完成路径会在编号 36
 *（BLACKSMITH_ORDER_CHEESE_MAKER）完成时设置这个准确状态位。它不会检查
 * 任一带索引的妊娠隔间链接。
 */
MaryBool IsCheeseMakerInstalled(void);

/*
 * Tests whether the Yarn Maker has been installed in the expanded Barn.
 * Parameters: none. Return value: the persistent installation flag. The native
 * blacksmith-order completion path sets this exact flag when order 37
 * (BLACKSMITH_ORDER_YARN_MAKER) finishes. It does not inspect either indexed
 * pregnancy-stall link.
 *
 * 判断扩建后的畜棚是否已经安装毛线团加工机。
 * 参数：无。返回值：持久安装标记。原生锻冶屋订单完成路径会在编号 37
 *（BLACKSMITH_ORDER_YARN_MAKER）完成时设置这个准确状态位。它不会检查任一
 * 带索引的妊娠隔间链接。
 */
MaryBool IsYarnMakerInstalled(void);
 ...
 * The native leaf performs no bounds check before indexing record_id * 8;
 * callers must stay within the declared 0-58 domain.
 *
 * 返回 MFoMT 指定钓鱼记录槽中的累计捕获数量。
 * 参数：record_id 为完整 59 槽域中的 FISHING_RECORD_*。
 * 返回值：所选八字节记录的第一个 32 位字段。MFoMT-US 与 MFoMT-JP 使用相同
 * 布局；编号 53-58 为鱼王。
 * 原生叶函数在按 record_id * 8 索引前不做边界检查；调用方必须使用声明的
 * 0-58 域内值。
 */
 ...
 * whole centimeters. Both regional fishing-record screens divide it by 100
 * for meters and use the remainder for centimeters. The native leaf performs
 * no bounds check before indexing record_id * 8.
 *
 * 返回 MFoMT 指定钓鱼记录槽中的最大捕获尺寸。
 * 参数：record_id 为完整 59 槽域中的 FISHING_RECORD_*。
 * 返回值：所选八字节记录的第二个 32 位字段，单位为整厘米。两个地区版的
 * 钓鱼记录界面都将其除以 100 显示米数，并以除以 100 的余数显示厘米数。
 * 原生叶函数在按 record_id * 8 索引前不做边界检查。
 */
 ...
 * Parameter: map_id is a MAP_* value for the selected MFoMT target.
 * Return value: TRUE when the ID is registered; FALSE otherwise.
 *
 ...
 * 解锁或当前能够进入该地图。
 * 参数：map_id 为当前 MFoMT 目标的 MAP_* 值。
 * 返回值：该 ID 已注册时为 TRUE，否则为 FALSE。
 */
 ...
 * tools.
 * Parameter: tool_kind is ITEM_TOOL_KIND_* in the public sickle/hoe/axe/
 * hammer/watering-can/fishing-rod order. Invalid kinds return zero.
 * Return value: the tool's unsigned 16-bit accumulated experience, or zero
 * for an invalid kind.
 *
 * 返回六种标准农具之一累计的 16 位使用经验。
 * 参数：tool_kind 使用 ITEM_TOOL_KIND_*，对外顺序为镰刀、锄头、斧头、锤子、
 * 洒水壶、钓竿。无效类别返回零。
 * 返回值：该农具累计的无符号 16 位经验；类别无效时为零。
 */
MaryItemToolExperienceValue GetToolExperience(MaryItemToolKind tool_kind);
 ...
 * Return value: the number of currently present winning animals for valid
 * inputs, subject to the documented horse defect.
 *
